...
> [!CAUTION]
> 《重大なバグ》<br>
> ・ゲーム開始時に「AIと対戦」を選択しないで下さい。同じプレイヤーが2回手を打ててしまうバグが発生しています。<br>
> ・Do not select "Play with AI" when starting the game. We discovered the bug that allows the same player to make two moves.
